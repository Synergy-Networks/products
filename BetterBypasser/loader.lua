	...
	if ValidScriptKey.code == "KEY_VALID" then
		...
		if not isfolder("BetterBypasser/Configurations") then
			if not isfolder("BetterBypasser") then
				makefolder("BetterBypasser")
			end
			makefolder("BetterBypasser/Configurations")
		end
		writefile("BetterBypasser/Configurations/SavedKey.txt", script_key)
	end
end

if not KeyValidated and isfolder("BetterBypasser/Configurations") and isfile("BetterBypasser/Configurations/SavedKey.txt") then
