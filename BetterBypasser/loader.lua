...
if not KeyValidated then
	...
	KeySection:CreateNew({
		Description = "Wanna skip the ads? Go to https://synergynetworks.mysellauth.com/ for BetterBypasser NOW for $3.99 via Bitcoin, Ethereum or Litecoin.",
	})
	...
	KeySection:CreateButton({
		...
		Icon = "rbxassetid://10709812159",
		Callback = function()
			setclipboard(" https://ads.luarmor.net/get_key?for=BetterBypasser__Rinku-kkGBJsMmsvBi")
			UI:Notify("Normal", {
				Title = "Clipboard set",
				Content = "Copied the key link to the clipboard.",
				Duration = 5,
