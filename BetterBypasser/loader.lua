...
if not KeyValidated then
	...
	KeySection:CreateButton({
		...
		Callback = function()
			setclipboard("https://ads.luarmor.net/get_key?for=BetterBypasser__WorkInk-DpfIKcLWFwwr")
			UI:Notify("Normal", {
				Title = "Clipboard set",
	...
	KeySection:CreateButton({
		...
		Icon = "rbxassetid://10709812159",
		Callback = function()
			setclipboard("https://ads.luarmor.net/get_key?for=BetterBypasser-GmyELoTdTHTK")
			UI:Notify("Normal", {
				Title = "Clipboard set",
				Content = "Copied the key link to the clipboard.",
				Duration = 5,
